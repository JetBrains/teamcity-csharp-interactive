namespace TeamCity.CSharpInteractive.Tests.UsageScenarios
{
    ...
    public class Scenario: IHost
    {
        ...
        public void Error(string error, string errorId = "Unknown") => Composer.Resolve<IHost>().Error(error, errorId);
        ...
        public void Trace(string trace, string origin = "") => Composer.Resolve<IHost>().Trace(trace, origin);
